            ...
            <div className="what-box-in">
               ...
               >
                  ...
                  <div className="what-content-in">
                     ...
                     <h4>Interactive & Animated Experiences</h4>
                     <p>
                        I specialize in building modern, responsive, and
                        visually engaging web interfaces using React and
                        Next.js, with a strong focus on smooth interactions,
                        clean design, and great user experiences.
                     </p>
               ...
               >
                  ...
                  <div className="what-content-in">
                     ...
                     <p>
                        I build end-to-end web and mobile applications with a
                        focus on performance, scalability, and seamless user
